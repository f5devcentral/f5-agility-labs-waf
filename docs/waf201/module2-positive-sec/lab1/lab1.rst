...
#. If you are continuing with the same deployment from the 101 or 102 classes, skip to Step 4, else click **Account > Login** in the top right and then click **Not yet a customer** on the login form.
